# [Game of Life](https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life) &middot; [![Build Status](https://travis-ci.org/awidiyadew/GameOfLife.svg?branch=master)](https://travis-ci.org/awidiyadew/GameOfLife) 
